...
import { useCollapsableList } from './hooks/use-collapsable-list.hook';
import { CollapsableList } from './collapsable-list.component';

jest.mock('./hooks/use-collapsable-list.hook');
