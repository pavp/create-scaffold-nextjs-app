...
describe('Header', () => {
  ...
  it('should render goBackButton, should be enabled by default', () => {
    const title = faker.lorem.word();
  ...
  it('should render goBackButton disabled', () => {
    const title = faker.lorem.word();

    renderWithProviders(<Header disableGoBackButton showGoBackButton title={title} />);

    expect(screen.getByTestId('go-back-button')).toBeInTheDocument();
    expect(screen.getByTestId('go-back-button')).not.toBeEnabled();
  });
