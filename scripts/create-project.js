...
// Main CLI function
async function main() {
  console.log(`${colors.bright}${colors.cyan}🚀 Scaffold Project Creator${colors.reset}`);
  console.log(`${colors.blue}Welcome to the Scaffold shared template CLI!${colors.reset}\n`);
